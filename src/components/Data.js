...
const Data = (props) => {
  ...
  return (
    <div className='flex justify-center w-[150%] min-h-[80%]'>

      {userData && !loading && (
        <div className='bg-[#1E2A47] rounded-xl p-8 grid grid-cols-2 gap-2 '>
            ...
            <div>
              ...
              <p className='text-sm mt-3 mb-3'>{userData.bio}</p>
            ...
            <div className='flex flex-col items-center'>
              ...
              <ul>
                {repositories.map((repo, index) => (
                  ...
                  <AiFillFolder/>
                  <a key={index} className='text-base'><a href={'https://github.com/'+ props.username+'/'+repo.name} 
                  target='_blank' className="text-blue-300 underline">{repo.name}</a></a>
                  </div>
